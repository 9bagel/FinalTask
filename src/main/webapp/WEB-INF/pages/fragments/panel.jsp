...
<c:if test="${user.userRole.id == 1}">
    ...
    <div class="list-group">
        <a href="/FinalTask/controller?command=manage_orders" class="list-group-item"><fmt:message bundle="${locale}" key="text.manage_orders"/></a>
        <a href="/FinalTask/controller?command=manage_users" class="list-group-item"><fmt:message bundle="${locale}" key="text.manage_users"/></a>
        <a href="/FinalTask/controller?command=add_service" class="list-group-item"><fmt:message bundle="${locale}" key="text.service.add"/></a>
